...
# source_password intentionally omitted to avoid hardcoding; store in Secrets Manager and set `secrets_manager_secret_name` if different from default
...
source_endpoints = {
  bolton = {
    ...
    username      = null
    # password omitted here - supply in Secrets Manager (see README) or set `source_password` var at runtime
