...
variable "source_username" {
  description = "Source database username (override). If null, read from Secrets Manager secret."
  type        = string
  default     = null
}
...
variable "secrets_manager_secret_name" {
  description = "Secrets Manager secret id/name for DMS credentials (JSON with 'username' and 'password')"
  type        = string
  default     = null
}
